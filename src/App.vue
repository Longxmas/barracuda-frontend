        ...
        <v-container fluid>
          <v-row>
            ...
            <v-col cols="1" class="mx-0" align-self="center">
              <v-card style="background-color: transparent" flat v-if="this.$store.getters['user/islogin'] !== 'true'">
              ...
              <v-card style="background-color: transparent" class="flex-row-reverse d-flex" flat v-else>
                <v-btn icon>
            ...
            <v-col cols="1" class="mx-0" align-self="center">
              ...
              <v-card style="background-color: transparent" class="flex-row-reverse d-flex" flat v-else>
                <a :href="'/user/' + this.$store.getters['user/id']" style="width: 80px; text-decoration: none; color: #ff8d1a;">
                  <v-card-text class="text-center text-h6" style="width: 80px">
                    <v-avatar rounded>
